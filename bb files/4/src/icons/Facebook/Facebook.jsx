...
export const Facebook = ({ className }) => {
  return (
    ...
    >
      <g className="g" filter="url(#filter0_d_49_70)">
        <path
          className="path"
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_49_70" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_49_70"
            mode="normal"
            result="shape"
          />
        </filter>
